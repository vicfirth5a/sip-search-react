...
function BarContent() {
  ...
  return (
    <>
      <section className="section section-breadcrumb">
        <div className="container">
          <ol className="breadcrumb fs-8 fs-lg-7">
    ...
    <section className="section section-about">
      <div className="container">
        <div className="txt" data-aos="fade-right">
          <div className="title">
            <h3 className="fs-4 fs-lg-3">關於酒吧</h3>
        ...
        <div className="pic" data-aos="fade-left" data-aos-duration="1000">
    ...
    <section className="section section-activity">
      <div className="container">
        <div className="txt" data-aos="fade-left" data-aos-duration="1000">
          <div className="title">
            <h3 className="fs-4 fs-lg-3">最新活動</h3>
      ...
      <div className="container">
        ...
        <div className="txt" data-aos="fade-left" data-aos-duration="1000">
          <div className="title text-center mb-lg-4">
            <h3 className="fs-4 fs-lg-3">聯繫我們</h3>
          </div>
          ...
          <div className="title text-center mb-lg-4">
            <h3 className="fs-4 fs-lg-3">營業時間</h3>
          </div>
    ...
    <section
      ...
      <div className="container">
        <h2 className="text-center mb-4 fs-4 fs-lg-3">聊聊這間酒吧</h2>
    ...
    >
      <div className="container">
        <h2 className="text-center mb-8 fs-4 fs-lg-3">你或許會喜歡</h2>
        <div className="similar-bars-list">
          <div
          ...
          >
            <div className="txt">
              <h3 className="bar-name eng-font">Sappho</h3>
              <p className="bar-intro">
          ...
          >
            <div className="txt">
              <h3 className="bar-name eng-font">Brown Sugar</h3>
              <p className="bar-intro">
