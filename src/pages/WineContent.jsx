...
function WineContent() {
  ...
  console.log("WineContent loaded");
    ...
    return (
      <>
        ...
        <div className="container">
          <section className="wine-comments" data-aos="zoom-in-up">
            ...
            <div className="wine-comments-section bg-primary-1 px-6 py-10 p-md-13">
                ...
                <li className="wine-comments-list-item d-flex" data-aos="fade-right">
                  <div className="wine-comments-list-info d-flex align-items-center">
                    <img
                      ...
                      className="avatar"
                    />
                    <span className="eng-font fs-8 fs-md-6 text-primary-4 fw-bold fs-8 fs-md-6 pt-1"
                      >Nate</span
                    >
                    <span
                  ...
                  <span className="wine-comments-list-area fs-9 fs-md-7">
                    <p className="">酸甜好滋味！！喝起來很順口</p>
                  </span>
                </li>
      ...
      <div
        className="row gx-lg-13 gy-lg-13 gy-md-10 gx-md-6 flex-md-wrap flex-nowrap overflow-x-scroll scrollBar pb-10 pb-lg-15" data-aos="zoom-in"
      >
